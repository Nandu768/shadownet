...
st.markdown(f'<h1 style="color:#8d1b92;text-align: center;font-size:36px;">{"Shadow Net: AI-Powered Network Traffic Analysis and Anomaly Detection System"}</h1>', unsafe_allow_html=True)
